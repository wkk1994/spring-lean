...
/**
 * @Description Bean初始化阶段示例，传统实例化方式和构造器依赖注入实例化方式
 * @Author Wangkunkun
 * @Date 2021/5/6 10:20
 */
public class BeanInitializationLifecycleDemo {
    ...
    public static void main(String[] args) {
        ...
        beanFactory.addBeanPostProcessor(new InstantiationAwareBeanPostProcessorDemo.MyInstantiationAwareBeanPostProcessor());
